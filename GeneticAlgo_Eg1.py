...
def main():
    ...
    while not found:
        ...
        population = sorted(population, key =
                                lambda x:x.fitness)

        # If the individual is having lowest fitness score,
        # i.e. 0, then we know that we have reached the target
        # and break the loop
        ...
        new_generation.extend(population[:s]) # take first 's' elements
